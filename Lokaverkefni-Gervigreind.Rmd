...
##Minna model bara ur LASSO

Best að nota Full gögning en taka ut categories með minna en 10 gildum. Gefur besta R adjusted og liklega betra MAE
...
names <- c(names,"loss")
data.small.lasso = data.small[,names]
data.small.lasso.train = data.small.lasso[train,]
data.small.lasso.test = data.small.lasso[-train,]


fit.lm.small <- lm(loss~.,data=data.small.lasso.train)
summary(fit.lm.small)
